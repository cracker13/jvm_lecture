...
/*
    java -Dsun.boot.class.path=./ com.cracker.jvm.classloader.MyTest23
...
public class MyTest23 {
    ...
    public static void main(String[] args) {
        ...
        /*
            指定系统类加载器，通过指定属性java -Djava.system.class.loader=com.cracker.jvm.classloader.MyTest16来改变系统类加载器
            显示指定系统类加载器：      java -Djava.system.class.loader=com.cracker.jvm.classloader.MyTest16 com.cracker.jvm.classloader.MyTest23

            查看ClassLoader类文档，记载指定系统类加载器，需要在MyTest16中添加一个构造方法
         */
